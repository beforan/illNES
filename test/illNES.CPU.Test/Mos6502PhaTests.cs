...
namespace illNES.CPU.Test
{
    public class Mos6502PhaTests
    {
        ...
        public Mos6502PhaTests()
        {
            ...
            _mMock.Setup(mem => mem.Read(0x8000)).Returns(0x48); //ROM start returns PHA
        ...
        [Fact]
        public void _0x48LeavesRegistersAlone()
        {
            var p = _cpu.P;
            _cpu.Tick();
        ...
        [Fact]
        public void _0x48PushesA()
        {
            _cpu.A = 5;

            _cpu.Tick();

            Assert.Equal(_cpu.A, _pushedValue);
        }

        [Fact]
        public void _0x48PushesToStackMemory()
        {
            var s = _cpu.S;
        ...
        [Fact]
        public void _0x48AdvancesProgramCounterBy1()
        {
            _cpu.Tick();
