...
namespace illNES.CPU.Test
{
    public class Mos6502ClcTests
    {
        ...
        public Mos6502ClcTests()
        {
            ...
            _mMock.Setup(mem => mem.Read(0x8000)).Returns(0x18); //ROM start returns CLC
            _m = _mMock.Object;
        ...
        [Fact]
        public void _0x18LeavesNonFlagsRegistersAlone()
        {
            var s = _cpu.S;
            _cpu.Tick();
        ...
        [Fact]
        public void _0x18AdvancesProgramCounterBy1()
        {
            _cpu.Tick();
        ...
        [Fact]
        public void _0x18ClearsCarryFlag()
        {
            _cpu.P |= PFlags.C;

            _cpu.Tick();

            Assert.False(_cpu.P.HasFlag(PFlags.C));
        }

        [Fact]
        public void _0x18Takes2Cycles()
        {
