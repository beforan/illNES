...
namespace illNES.CPU.Test
{
    public class Mos6502SecTests
    {
        ...
        public Mos6502SecTests()
        {
            ...
            _mMock.Setup(mem => mem.Read(0x8000)).Returns(0x38); //ROM start returns SEC
            _m = _mMock.Object;
        ...
        [Fact]
        public void _0x38LeavesNonFlagsRegistersAlone()
        {
            var s = _cpu.S;
            _cpu.Tick();
        ...
        [Fact]
        public void _0x38AdvancesProgramCounterBy1()
        {
            _cpu.Tick();
        ...
        [Fact]
        public void _0x38SetsCarryFlag()
        {
            _cpu.Tick();

            Assert.True(_cpu.P.HasFlag(PFlags.C));
        }

        [Fact]
        public void _0x38Takes2Cycles()
        {
