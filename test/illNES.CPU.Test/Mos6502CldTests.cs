...
namespace illNES.CPU.Test
{
    public class Mos6502CldTests
    {
        ...
        public Mos6502CldTests()
        {
            ...
            _mMock.Setup(mem => mem.Read(0x8000)).Returns(0xd8); //ROM start returns CLC
            _m = _mMock.Object;
        ...
        [Fact]
        public void _0xd8LeavesNonFlagsRegistersAlone()
        {
            var s = _cpu.S;
            _cpu.Tick();
        ...
        [Fact]
        public void _0xd8AdvancesProgramCounterBy1()
        {
            _cpu.Tick();
        ...
        [Fact]
        public void _0xd8ClearsDecimalFlag()
        {
            _cpu.P |= PFlags.D;

            _cpu.Tick();

            Assert.False(_cpu.P.HasFlag(PFlags.D));
        }

        [Fact]
        public void _0xd8Takes2Cycles()
        {
