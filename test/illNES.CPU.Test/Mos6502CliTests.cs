...
namespace illNES.CPU.Test
{
    public class Mos6502CliTests
    {
        ...
        public Mos6502CliTests()
        {
            ...
            _mMock.Setup(mem => mem.Read(0x8000)).Returns(0x58); //ROM start returns CLC
            _m = _mMock.Object;
        ...
        [Fact]
        public void _0x58LeavesNonFlagsRegistersAlone()
        {
            var s = _cpu.S;
            _cpu.Tick();
        ...
        [Fact]
        public void _0x58AdvancesProgramCounterBy1()
        {
            _cpu.Tick();
        ...
        [Fact]
        public void _0x58ClearsInterruptFlag()
        {
            _cpu.Tick();

            Assert.False(_cpu.P.HasFlag(PFlags.I));
        }

        [Fact]
        public void _0x58Takes2Cycles()
        {
