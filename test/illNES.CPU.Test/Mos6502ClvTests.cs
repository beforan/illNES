...
namespace illNES.CPU.Test
{
    public class Mos6502ClvTests
    {
        ...
        public Mos6502ClvTests()
        {
            ...
            _mMock.Setup(mem => mem.Read(0x8000)).Returns(0xb8); //ROM start returns CLC
            _m = _mMock.Object;
        ...
        [Fact]
        public void _0xb8LeavesNonFlagsRegistersAlone()
        {
            var s = _cpu.S;
            _cpu.Tick();
        ...
        [Fact]
        public void _0xb8AdvancesProgramCounterBy1()
        {
            _cpu.Tick();
        ...
        [Fact]
        public void _0xb8ClearsCarryFlag()
        {
            _cpu.P |= PFlags.V;

            _cpu.Tick();

            Assert.False(_cpu.P.HasFlag(PFlags.V));
        }

        [Fact]
        public void _0xb8Takes2Cycles()
        {
